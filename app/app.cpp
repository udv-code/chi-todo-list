...
#define W_HEIGHT 5 * FIELD_HEIGHT + 9 * FIELD_MARGIN
...
namespace udv {
	...
	HRESULT WinApp::Initialize(HINSTANCE hInstance) {
		...
		if (SUCCEEDED(hr)) {
			...
			if (SUCCEEDED(hr)) {
				m_hStatus = ::CreateWindow(
						...
						FIELD_MARGIN, FIELD_MARGIN, FIELD_WIDTH, FIELD_HEIGHT * 2,
						m_hwnd, nullptr,
						hInstance, nullptr);
				m_hEditMessage = ::CreateWindow(
						...
						FIELD_MARGIN, FIELD_MARGIN * 2 + FIELD_HEIGHT * 2, FIELD_WIDTH, FIELD_HEIGHT,
						m_hwnd, nullptr,
						hInstance, nullptr);
				m_hEditTime = ::CreateWindow(
						...
						"",
						ES_LEFT | ES_MULTILINE | WS_CHILD | WS_VISIBLE | WS_BORDER,
						FIELD_MARGIN, FIELD_MARGIN * 3 + FIELD_HEIGHT * 3, FIELD_WIDTH, FIELD_HEIGHT,
						m_hwnd, nullptr,
						hInstance, nullptr);
				::CreateWindow(
						"BUTTON",
						...
						FIELD_MARGIN, FIELD_MARGIN * 4 + FIELD_HEIGHT * 4, FIELD_WIDTH, FIELD_HEIGHT,
		...
		SetStatus(
				"Welcome! Input message and date in format Mon D Year HH::mm::ss, for example: Dec 6 2020 20:20:20(optional: you can put interval for periodic items on a next line (m - minute, H - hour, W - Week, M - month)) in fields below and click schedule!");
